...
class WSI2Graph_Generator():
    ...
    def __init__(self, pred_column, feature_extractor_name, feature_extractor_path, model_weights_filename, knn_list, magnification_level, include_edge_features, edges_type,
        ...
        self.train_paths_df, self.val_paths_df, self.test_paths_df = self.get_patches_paths_df(dir_dataset_splitting=self.dir_dataset_splitting,
    ...
    def get_patches_paths_df(self, dir_dataset_splitting, dir_data_frame, pred_column, dir_excels_class_perc):
        # Dataset split
        train_ids, test_ids, val_ids = get_train_test_val_ids(dir_dataset_splitting)
    ...
    def load_MIL_datasets_coordinates(self):
